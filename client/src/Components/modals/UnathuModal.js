...
class UnauthModal extends Component {
    handleCloseModal = () => {
        if(this.props.location.pathname.includes('/event')){//keep the guest on the event page if they click cancel
            this.props.closeModal();
        } else {// user is on a page that is not authorized take them back
